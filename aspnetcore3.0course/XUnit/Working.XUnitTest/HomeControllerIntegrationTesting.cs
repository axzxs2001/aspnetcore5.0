...
namespace Working.XUnitTest
{
    ...
    public class HomeControllerIntegrationTesting : IClassFixture<WebApplicationFactory<Working.Startup>>
    {
        private readonly WebApplicationFactory<Startup> _factory;      
        private readonly HttpClient _client;
        public HomeControllerIntegrationTesting(WebApplicationFactory<Working.Startup> factory)
        {
            _factory = factory;       
